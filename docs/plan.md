...
[~] [작업] 20260818-m2-battle-complete — M2 전투 완성 ..... in-progress (10/14)  depends: M1
...
flowchart TD
    ...
    M2["M2 전투 완성 (10/14)<br/>20260818-m2-battle-complete"]:::active
    M0 -. depends .-> M1
    M1 -. depends .-> M2
