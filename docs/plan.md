...
- 현재 결론 또는 상태: **M0 사이클 완료**(TASK-01~09, 검증 4/4 성공, [기록](./work/20260817-m0-skeleton/work-log.md)). **M1 사이클 완료**(TASK-10~20, 검증 VER-05~08 4/4 충족, [기록](./work/20260817-m1-battle-prototype/work-log.md)) — 화면에서 전투 한 판을 승리까지 완주했고 테스트 184건·타입 검사·데이터 검증·빌드가 모두 성공했다. **M2 사이클 진행 중**(3/14) — 작업 14건(TASK-21~34)과 검증 7건(VER-09~15)을 아래에 정의했고, [TASK-21](#task-21-사기혼란과-턴-시작-처리)(사기·혼란·턴 시작 처리)·[TASK-22](#task-22-경험치레벨업)(경험치·레벨업)·[TASK-23](#task-23-책략-데이터-계약과-책략치mp)(책략 데이터 계약과 책략치)·[TASK-24](#task-24-책략-실행-커맨드)(책략 실행 커맨드)·[TASK-25](#task-25-아이템-데이터-계약과-장비-효과)(아이템 데이터 계약과 장비 효과)·[TASK-26](#task-26-아이템-사용과-승급계열-전환)(아이템 사용과 승급·계열 전환)·[TASK-27](#task-27-병과-플래그와-반격)(병과 플래그와 반격)·[TASK-28](#task-28-보물군량고-조사와-날씨)(보물·군량고 조사와 날씨)·[TASK-29](#task-29-전투-이벤트-dsl-인터프리터)(전투 이벤트 DSL 인터프리터)·[TASK-30](#task-30-일기토)(일기토)·[TASK-31](#task-31-2단계-적-ai)(2단계 적 AI)— 작업 14건을 모두 구현했고 검증 7건 중 5건(VER-10·11·13·14·15)을 충족했다. **VER-09(화면 완주)는 실행 환경에 Chromium 계열 브라우저가 없어 차단**되었고, 원작 실측 자료가 없어 `[검증]` 상수 8건이 미확정으로 남았다([RISK-M2-01](#위험)). 테스트 472건·타입 검사·데이터 검증·빌드가 모두 성공한다.
- 다음 행동: **VER-09를 브라우저가 있는 환경에서 실행**하고 결과를 [M2 작업 기록](./work/20260818-m2-battle-complete/work-log.md)에 덧붙인다. 그 뒤 M3(캠페인·세이브)를 [wf-design](../../.claude/skills/wf-design/SKILL.md) 없이 이어갈지 판단한다(wf-implement §3.3 TDD 사이클). 진행 상태는 이 문서의 작업 목록과 [M2 작업 기록](./work/20260818-m2-battle-complete/work-log.md)에 갱신한다.
...
[~] [작업] 20260818-m2-battle-complete — M2 전투 완성 ..... partial (14/14 구현, VER-09 차단)  depends: M1
    ...
    ├─ [✓] TASK-25 구현: 아이템 데이터 계약과 장비 효과    completed  2026-08-18 08:52
    ├─ [✓] TASK-26 구현: 아이템 사용과 승급·계열 전환      completed  2026-08-18 13:15
    ├─ [✓] TASK-27 구현: 병과 플래그와 반격              completed  2026-08-18 13:35
    ├─ [✓] TASK-28 구현: 보물·군량고 조사와 날씨           completed  2026-08-18 13:55
    ├─ [✓] TASK-29 구현: 전투 이벤트 DSL 인터프리터        completed  2026-08-19 00:20
    ├─ [✓] TASK-30 구현: 일기토                            completed  2026-08-19 00:40
    ├─ [✓] TASK-31 구현: 2단계 적 AI                       completed  2026-08-19 01:05
    ├─ [✓] TASK-32 구현: 전투 UI 확장                      completed  2026-08-20 (화면 확인은 VER-09)
    ├─ [~] TASK-33 검증: M2 검증 스테이지와 원작 대조 튜닝  partial (VER-14 성공, VER-09 차단)  depends: TASK-31, TASK-32
...
flowchart TD
    ...
    M2 --> T33["TASK-33 검증 스테이지·원작 대조 튜닝"]:::gate
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-21-사기혼란과-턴-시작-처리))
- 상위: 없음
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-22-경험치레벨업))
- 상위: 없음
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-23-책략-데이터-계약과-책략치mp))
- 상위: 없음
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-25-아이템-데이터-계약과-장비-효과))
- 상위: 없음
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-26-아이템-사용과-승급계열-전환))
- 상위: 없음
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-27-병과-플래그와-반격))
- 상위: 없음
...
- 상태: completed (2026-08-18 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-18--task-28-보물군량고-조사와-날씨))
- 상위: 없음
...
- 상태: completed (2026-08-19 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-19--task-29-전투-이벤트-dsl-인터프리터))
- 상위: 없음
...
- 상태: completed (2026-08-19 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-19--task-30-일기토))
- 상위: 없음
...
- 상태: completed (2026-08-19 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-19--task-31-2단계-적-ai))
- 상위: 없음
...
- 상태: completed (2026-08-20 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-20--task-32-전투-ui-확장). 그리기·연출의 화면 확인은 [VER-09](#검증-계획)에 합류)
- 상위: 없음
...
- 상태: partial (2026-08-20 — 검증 스테이지 완성·VER-14 성공, **VER-09는 실행 환경 부재로 차단**. [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-20--task-33-m2-검증-스테이지와-원작-대조-튜닝))
- 상위: 없음
...
- 상태: completed (2026-08-21 — [수행 기록](./work/20260818-m2-battle-complete/work-log.md#2026-08-21--task-34-자체-리뷰전체-검증통합))
- 상위: 없음
...
- 완료된 항목: M0 사이클 TASK-01~09(검증 VER-01~04), M1 사이클 TASK-10~20(검증 VER-05~08), **M2 계획 수립**(TASK-21~34, VER-09~15, 계획 트리 재생성 — 2026-08-18), **M2 [TASK-21](#task-21-사기혼란과-턴-시작-처리)**(사기·혼란·턴 시작 처리)·**[TASK-22](#task-22-경험치레벨업)**(경험치·레벨업)·**[TASK-23](#task-23-책략-데이터-계약과-책략치mp)**(책략 데이터 계약과 책략치)·**[TASK-24](#task-24-책략-실행-커맨드)**(책략 실행 커맨드)·**[TASK-25](#task-25-아이템-데이터-계약과-장비-효과)**(아이템 데이터 계약과 장비 효과)·**[TASK-26](#task-26-아이템-사용과-승급계열-전환)**(아이템 사용과 승급·계열 전환)·**[TASK-27](#task-27-병과-플래그와-반격)**(병과 플래그와 반격)·**[TASK-28](#task-28-보물군량고-조사와-날씨)**(보물·군량고 조사와 날씨 — 2026-08-18)·**[TASK-29](#task-29-전투-이벤트-dsl-인터프리터)**(전투 이벤트 DSL 인터프리터)·**[TASK-30](#task-30-일기토)**(일기토)·**[TASK-31](#task-31-2단계-적-ai)**(2단계 적 AI — 2026-08-19)·**[TASK-32](#task-32-전투-ui-확장)**(전투 UI 확장 — 2026-08-20)
- 미완료 항목: **VER-09**(브라우저 부재로 차단)와 `[검증]` 상수 8건의 원작 대조, M3~M6 전부
- 차단 요인: 없음
- 다음 행동: **VER-09**를 브라우저가 있는 환경에서 실행한다(`npm run dev` 후 M1과 같은 CDP 하네스). 실측 자료를 확보하면 `[검증]` 상수 8건을 `combat-config.json`에서 고친다 — 코드 수정은 필요하지 않다(VER-14로 확인)
