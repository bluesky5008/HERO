...
[~] [작업] 20260818-m2-battle-complete — M2 전투 완성 ..... in-progress (11/14)  depends: M1
...
flowchart TD
    ...
    M2["M2 전투 완성 (11/14)<br/>20260818-m2-battle-complete"]:::active
    M0 -. depends .-> M1
    M1 -. depends .-> M2
...
- 미완료 항목: M2 구현 TASK-32~34(11/14 완료), M3~M6 전부
- 차단 요인: 없음
- 다음 행동: [TASK-32 전투 UI 확장](#task-32-전투-ui-확장)의 선행 테스트(`tests/scenes/interaction.test.ts`)를 먼저 작성해 실패를 확인한 뒤 구현한다. 착수 시 TASK-32의 상태를 `in-progress`로 바꾸고 같은 변경에서 [계획 트리](#계획-트리)를 재생성한다
